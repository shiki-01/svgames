...
<header
	class="w-full h-[40px] py-2 px-5 z-50 bg-slate-600/50 text-slate-50 backdrop-blur-md shadow-md shadow-slate-600/50 rounded-full grid grid-cols-3 items-center">
